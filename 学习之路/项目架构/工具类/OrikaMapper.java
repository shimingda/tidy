 ...
 * 
 * <p>
 * Description:简单封装orika, 实现深度转换Bean<->Bean的Mapper
 * </p>
 * Project: Project: com.rw.ssd.biz.utils.OrikaMapper: OrikaMapper.java
 * 
...
public class OrikaMapper {
    ...
    /**
     * 极致性能的复制出新类型对象到数组 预先通过BeanMapper.getType() 静态获取并缓存Type类型，在此处传入
     */
